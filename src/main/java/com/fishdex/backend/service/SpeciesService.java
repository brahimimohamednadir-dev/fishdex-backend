...
public class SpeciesService {
    ...
    private SpeciesResponse buildResponse(Species species, User user, boolean withTips) {
        ...
        if (species.getId() != null) {
            ...
            Optional<Capture> fishDexCapture = captureRepository.findFishDexRecordBySpeciesId(species.getId());
            ...
            if (user != null) {
                ...
                if (caught) {
                    ...
                    Optional<Capture> pr = captureRepository.findPersonalRecordByUserIdAndSpeciesId(user.getId(), species.getId());
                    if (pr.isPresent()) {
                        Capture r = pr.get();
